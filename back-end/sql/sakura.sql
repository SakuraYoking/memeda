...
(14, 4, '/img/shop/14.png', 'DJI大师摇轮', 'Master Wheels 是大疆推出的一款专业级的摇轮控制器，采用高精度传感器配合全新的控制算法...'),
(15, 4, '/img/shop/15.png', 'DJI体感控制器专业版', 'DJI体感控制器专业版采用了先进的通信技术配合全新的控制算法，使云台系统能实时响应...'),
